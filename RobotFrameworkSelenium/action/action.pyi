...
class SeleniumAction(BasicCommon):
	...
	def selenium_click_until_not_find_element(self, click_locator, check_locator, x = 0, y = 0, operate = 'click', check_exist = False, screenshot_name = 'python-screenshot.png', timeout = 30.0, init_check = True, init_sleep = 0.0, wait_before_check = 0.0, do_interval = 1.0, wait_timeout=0.5, check_interval = 0.2, error = True):
		...
		"""
		...
	def selenium_wait_until_find_element_attribute(self, find_locator, find_value = '', find_attribute = 'innerText', attribute_type='', regex = True, check_bool = True, screenshot_name = 'python-screenshot.png', timeout = 30.0, init_check = True, init_sleep = 0.0, wait_before_check = 0.0, do_interval = 1.0, check_interval = 0.2, error = True):
		"""
		"""
		...
	...
	def selenium_wait_until_stable_not_find_element(self, check_locator, check_exist = False, screenshot_name = 'python-screenshot.png', timeout = 30.0, init_check = True, init_sleep = 0.0, stable_time = 3.0, check_interval = 0.2, error = True):
		...
		"""
		...
	def selenium_wait_until_stable_find_element_attribute(self, find_locator, find_value = '', find_attribute = 'innerText', attribute_type='', regex = True, check_bool = True, screenshot_name = 'python-screenshot.png', timeout = 30.0, init_check = True, init_sleep = 0.0, stable_time = 3.0, check_interval = 0.2, error = True):
		"""
		"""
		...
