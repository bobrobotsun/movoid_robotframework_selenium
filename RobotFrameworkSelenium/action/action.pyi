...
class SeleniumAction(RobotFrameworkSelenium.common.BasicCommon):
	...
	def selenium_click_element(self, click_locator, operate = 'click', _return_when_error = None, _log_keyword_structure = True):
		...
		"""
		...
	def selenium_get_element_color_list(self, screenshot_locator = None, _return_when_error = None, _log_keyword_structure = True):
		"""
		获得目标元素的颜色列表
	...
	def selenium_click_element_with_offset(self, click_locator, x = 0, y = 0, operate = 'click', _return_when_error = None, _log_keyword_structure = True):
		...
		"""
		...
	def selenium_check_element_attribute(self, check_locator, check_value, check_attribute = 'innerText', attribute_type = '', regex: bool = True, check_bool: bool = True, _return_when_error = None, _log_keyword_structure = True):
		"""
		检查目标元素的属性是否满足某个条件
	...
	def selenium_find_elements_with_attribute(self, find_locator, find_value = '', find_attribute = 'innerText', attribute_type = '', regex = True, check_bool = True, _return_when_error = None, _log_keyword_structure = True):
		...
		"""
		...
	def selenium_find_element_with_attribute(self, find_locator, find_value = '', find_attribute = 'innerText', attribute_type = '', regex = True, check_bool = True, _return_when_error = None, _log_keyword_structure = True):
		"""
	...
	def selenium_delete_elements(self, delete_locator, _return_when_error = None, _log_keyword_structure = True):
		...
		"""
		...
	def selenium_check_contain_element(self, check_locator, check_exist: bool = True, _return_when_error = None, _log_keyword_structure = True):
		"""
		检查页面内是否存在某个元素
		...
		"""
		...
	def selenium_check_contain_elements(self, check_locator, check_count: int = 1, _return_when_error = None, _log_keyword_structure = True):
		"""
		检查页面内某些元素的总数是否为特定的值
		:param check_locator: 目标元素或locator
...
class SeleniumActionUntil(SeleniumAction):
	def selenium_click_until_available(self, click_locator, x = 0, y = 0, operate = 'click', timeout = 30.0, init_check = True, init_sleep = 0.0, wait_before_check = 0.0, do_interval = 1.0, check_interval = 0.2, error = True, _return_when_error = None, _log_keyword_structure = True, __debug_default = None, __debug_debug = None):
		...
		******************** 下方是辅助函数和参数，请忽略return参数 ********************
		...
		"""
		...
	def selenium_wait_until_find_element(self, check_locator, check_exist: bool = True, timeout = 30.0, init_check = True, init_sleep = 0.0, wait_before_check = 0.0, do_interval = 1.0, check_interval = 0.2, error = True, _return_when_error = None, _log_keyword_structure = True, __debug_default = None, __debug_debug = None):
		"""
		...
		******************** 下方是辅助函数和参数，请忽略return参数 ********************
		...
		"""
		...
	def selenium_wait_until_not_find_element(self, check_locator, check_exist: bool = False, timeout = 30.0, init_check = True, init_sleep = 0.0, wait_before_check = 0.0, do_interval = 1.0, check_interval = 0.2, error = True, _return_when_error = None, _log_keyword_structure = True, __debug_default = None, __debug_debug = None):
		"""
		...
		******************** 下方是辅助函数和参数，请忽略return参数 ********************
		...
		"""
		...
	def selenium_click_until_find_elements(self, click_locator, check_locator, x = 0, y = 0, operate = 'click', check_count: int = 1, timeout = 30.0, init_check = True, init_sleep = 0.0, wait_before_check = 0.0, do_interval = 1.0, check_interval = 0.2, error = True, _return_when_error = None, _log_keyword_structure = True, __debug_default = None, __debug_debug = None):
		"""
		...
		******************** 下方是辅助函数和参数，请忽略return参数 ********************
		...
		"""
		...
	def selenium_click_until_find_element(self, click_locator, check_locator, x = 0, y = 0, operate = 'click', check_exist: bool = True, timeout = 30.0, init_check = True, init_sleep = 0.0, wait_before_check = 0.0, do_interval = 1.0, check_interval = 0.2, error = True, _return_when_error = None, _log_keyword_structure = True, __debug_default = None, __debug_debug = None):
		"""
		...
		******************** 下方是辅助函数和参数，请忽略return参数 ********************
		...
		"""
		...
	def selenium_click_until_not_find_element(self, click_locator, check_locator, x = 0, y = 0, operate = 'click', check_exist: bool = False, timeout = 30.0, init_check = True, init_sleep = 0.0, wait_before_check = 0.0, do_interval = 1.0, check_interval = 0.2, error = True, _return_when_error = None, _log_keyword_structure = True, __debug_default = None, __debug_debug = None):
		"""
		:param check_exist: 现在默认值为False
		...
		******************** 下方是辅助函数和参数，请忽略return参数 ********************
		...
		"""
		...
	def selenium_wait_until_find_element_attribute(self, find_locator, find_value = '', find_attribute = 'innerText', attribute_type = '', regex = True, check_bool = True, timeout = 30.0, init_check = True, init_sleep = 0.0, wait_before_check = 0.0, do_interval = 1.0, check_interval = 0.2, error = True, _return_when_error = None, _log_keyword_structure = True, __debug_default = None, __debug_debug = None):
		"""
		...
		******************** 下方是辅助函数和参数，请忽略return参数 ********************
		...
		"""
		...
	def selenium_click_until_find_element_attribute(self, click_locator, find_locator, x = 0, y = 0, operate = 'click', find_value = '', find_attribute = 'innerText', attribute_type = '', regex = True, check_bool = True, timeout = 30.0, init_check = True, init_sleep = 0.0, wait_before_check = 0.0, do_interval = 1.0, check_interval = 0.2, error = True, _return_when_error = None, _log_keyword_structure = True, __debug_default = None, __debug_debug = None):
		"""
	...
	def selenium_click_until_element_count_change(self, click_locator, check_locator, x = 0, y = 0, operate = 'click', timeout = 30.0, init_check = True, init_sleep = 0.0, wait_before_check = 0.0, do_interval = 1.0, check_interval = 0.2, error = True, _return_when_error = None, _log_keyword_structure = True, __debug_default = None, __debug_debug = None):
		...
		******************** 下方是辅助函数和参数，请忽略return参数 ********************
		...
		"""
		...
	def selenium_wait_until_stable_find_element(self, check_locator, check_exist: bool = True, timeout = 30.0, init_check = True, init_sleep = 0.0, stable_time = 3.0, check_interval = 0.2, error = True, _return_when_error = None, _log_keyword_structure = True, __debug_default = None, __debug_debug = None):
		"""
		...
		******************** 下方是辅助函数和参数，请忽略return参数 ********************
		...
		"""
		...
	def selenium_wait_until_stable_find_elements(self, check_locator, check_count: int = 1, timeout = 30.0, init_check = True, init_sleep = 0.0, stable_time = 3.0, check_interval = 0.2, error = True, _return_when_error = None, _log_keyword_structure = True, __debug_default = None, __debug_debug = None):
		"""
		...
		******************** 下方是辅助函数和参数，请忽略return参数 ********************
		...
		"""
		...
	def selenium_wait_until_stable_not_find_element(self, check_locator, check_exist: bool = False, timeout = 30.0, init_check = True, init_sleep = 0.0, stable_time = 3.0, check_interval = 0.2, error = True, _return_when_error = None, _log_keyword_structure = True, __debug_default = None, __debug_debug = None):
		"""
		:param check_exist: 现在默认值为False
		...
		******************** 下方是辅助函数和参数，请忽略return参数 ********************
		...
		"""
		...
	def selenium_wait_until_stable_find_element_attribute(self, find_locator, find_value = '', find_attribute = 'innerText', attribute_type = '', regex = True, check_bool = True, timeout = 30.0, init_check = True, init_sleep = 0.0, stable_time = 3.0, check_interval = 0.2, error = True, _return_when_error = None, _log_keyword_structure = True, __debug_default = None, __debug_debug = None):
		"""
