...
class SeleniumAction(BasicCommon):
    ...
    def selenium_click_element(self, click_locator, operate='click', timeout=3):
        self.selenium_wait_until_find_element(click_locator, timeout=timeout)
    ...
    @robot_log_keyword
    def selenium_click_element_with_offset(self, click_locator, x=0, y=0, operate='click', timeout=3):
        self.selenium_wait_until_find_element(click_locator, timeout=timeout)
